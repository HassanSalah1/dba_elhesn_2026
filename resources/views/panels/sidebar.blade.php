    ...
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
          ...
          <span class="brand-logo">
            <img src="{{ asset('images/logo/dh_logo.png') }}" alt="شعار نادي دبا الحصن" style="height: 36px; width: auto; object-fit: contain;">
          </span>
        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @if(isset($menuData[0]))
                @foreach($menuData[0]->menu as $menu)
                    @if(!isset($menu->permission) || auth()->user()->checkPermission($menu->permission))
